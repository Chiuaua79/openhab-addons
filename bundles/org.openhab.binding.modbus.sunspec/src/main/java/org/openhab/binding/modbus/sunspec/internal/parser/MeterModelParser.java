...
public class MeterModelParser extends AbstractBaseParser implements SunspecParser<MeterModelBlock> {
    ...
    public MeterModelBlock parse(ModbusRegisterArray raw) {
        ...
        block.acExportedRealEnergyTotal = extractOptionalUInt32(raw, 38);
        block.phaseA.acExportedRealEnergy = extractOptionalUInt32(raw, 40);
        block.phaseB.acExportedRealEnergy = extractOptionalUInt32(raw, 42);
        block.phaseC.acExportedRealEnergy = extractOptionalUInt32(raw, 44);
        block.acImportedRealEnergyTotal = extractUInt32(raw, 46, 0);
        block.phaseA.acImportedRealEnergy = extractOptionalUInt32(raw, 48);
        block.phaseB.acImportedRealEnergy = extractOptionalUInt32(raw, 50);
        block.phaseC.acImportedRealEnergy = extractOptionalUInt32(raw, 52);
        block.acRealEnergySF = extractSunSSF(raw, 54);

        block.acExportedApparentEnergyTotal = extractOptionalUInt32(raw, 55);
        block.phaseA.acExportedApparentEnergy = extractOptionalUInt32(raw, 57);
        block.phaseB.acExportedApparentEnergy = extractOptionalUInt32(raw, 59);
        block.phaseC.acExportedApparentEnergy = extractOptionalUInt32(raw, 61);
        block.acImportedApparentEnergyTotal = extractOptionalUInt32(raw, 63);
        block.phaseA.acImportedApparentEnergy = extractOptionalUInt32(raw, 65);
        block.phaseB.acImportedApparentEnergy = extractOptionalUInt32(raw, 67);
        block.phaseC.acImportedApparentEnergy = extractOptionalUInt32(raw, 69);
        block.acApparentEnergySF = extractOptionalSunSSF(raw, 71);

        block.acImportedReactiveEnergyQ1Total = extractOptionalUInt32(raw, 72);
        block.phaseA.acImportedReactiveEnergyQ1 = extractOptionalUInt32(raw, 74);
        block.phaseB.acImportedReactiveEnergyQ1 = extractOptionalUInt32(raw, 76);
        block.phaseC.acImportedReactiveEnergyQ1 = extractOptionalUInt32(raw, 78);
        block.acImportedReactiveEnergyQ2Total = extractOptionalUInt32(raw, 80);
        block.phaseA.acImportedReactiveEnergyQ2 = extractOptionalUInt32(raw, 82);
        block.phaseB.acImportedReactiveEnergyQ2 = extractOptionalUInt32(raw, 84);
        block.phaseC.acImportedReactiveEnergyQ2 = extractOptionalUInt32(raw, 86);
        block.acExportedReactiveEnergyQ3Total = extractOptionalUInt32(raw, 88);
        block.phaseA.acExportedReactiveEnergyQ3 = extractOptionalUInt32(raw, 90);
        block.phaseB.acExportedReactiveEnergyQ3 = extractOptionalUInt32(raw, 92);
        block.phaseC.acExportedReactiveEnergyQ3 = extractOptionalUInt32(raw, 94);
        block.acExportedReactiveEnergyQ4Total = extractOptionalUInt32(raw, 96);
        block.phaseA.acExportedReactiveEnergyQ4 = extractOptionalUInt32(raw, 98);
        block.phaseB.acExportedReactiveEnergyQ4 = extractOptionalUInt32(raw, 100);
        block.phaseC.acExportedReactiveEnergyQ4 = extractOptionalUInt32(raw, 102);
